package Vista_Panel_Auxiliar;

import Vista_Panel_Administrador.*;
import Vista_Panel_Contador.*;
...
public class Panel_Auxiliar extends javax.swing.JFrame {
    ...
    public Panel_Auxiliar(Modelo_Usuario User) {
        initComponents();
    ...
    private void Btn_Libro_DiarioMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Btn_Libro_DiarioMouseClicked
        ...
        try {
            ...
            Logger.getLogger(Panel_Auxiliar.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new Panel_Auxiliar().setVisible(true);
        });
    }
